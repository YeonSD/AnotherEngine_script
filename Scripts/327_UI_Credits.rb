...
class Scene_Credits
  ...
  def get_text
    ...
    ret.push("")
    ret.push(_INTL("[Map Pack] Remastered Kanto and Johto Overworld and Caves, with Bonus Beta maps (and Music)"))
    ret.push(_INTL("~ Original FRLG maps ~"))
    add_names_to_credits(ret, [
    "GameFreak","JohtoBlaziken"
    ])
    ret.push("")
    ret.push(_INTL("~ Johto Caves ~"))
    add_names_to_credits(ret, [
    ...
    ret.push(_INTL("~ Map modifications and 50/60's Kanto ~"))
    add_names_to_credits(ret, [
    "AenaonDusky, from \"PS: The First Journey\""
    ])
    ret.push("")
    ret.push(_INTL("~ Music ~"))
    add_names_to_credits(ret, [
    "Gamefreak","FRLG Midis ripped by MarinaraSauce","Remastered and rearranged by AenaonDusky"
    ])
    ret.push("")
    ret.push("")
    ret.push(_INTL("[Maps] Kanto, Johto, Hoenn RMXP map packs"))
    ret.push(_INTL("Some of Kanto & Johto made by : BenGames,Films, and More!"))
    ret.push(_INTL("Hoenn Made by : Jorinho"))
    ret.push(_INTL("Used Tileset \"Outside Emerald\""))
    ret.push("")
    ret.push("")
    ret.push(_INTL("ADDITIONAL TILSET BY"))
    add_names_to_credits(ret, ["Cinna", "lichenprincess"])
    ret.push("")
    ret.push("")
    ...
    "Miused","ShiningStar5022","PIXAI","YOUNG","THEcubberx","TobalCRV"
    ])
    ret.push("")
    ret.push("")
    ret.push(_INTL("Z-A MEGA EVOLUTION SPRITE BY"))
    add_names_to_credits(ret, [
    "RetroNC","BluebirdDxD"
    ])
    ret.push("")
    ret.push("")
    ret.push(_INTL("Character Customization Resources BY"))
    ret.push("Coffee Cup/Poltergeist")
    ret.push("")
    ret.push("")
    ret.push(_INTL("ORIGINAL MUSIC BY"))
    add_names_to_credits(ret, ["YOUNG"])
    ret.push("")
    ret.push("")
