...
def pbPokemonMart3
  stock = [
    :NORMALIUMZ, :FIGHTINIUMZ, :FLYINIUMZ, :POISONIUMZ, :GROUNDIUMZ, 
  :ROCKIUMZ, :BUGINIUMZ, :GHOSTIUMZ, :STEELIUMZ, :FIRIUMZ,  :WATERIUMZ, :GRASSIUMZ, 
  :ELECTRIUMZ, :PSYCHIUMZ, :ICIUMZ,  :DRAGONIUMZ, :DARKINIUMZ, :FAIRIUMZ,
  :PIKANIUMZ, :ALORAICHIUMZ, :EEVIUMZ, :SNORLIUMZ, :MEWNIUMZ,
  :DECIDIUMZ, :INCINIUMZ, :PRIMARIUMZ, :LYCANIUMZ, :MIMIKIUMZ,
  :KOMMONIUMZ, :TAPUNIUMZ, :SOLGANIUMZ, :LUNALIUMZ, :MARSHADIUMZ,
  :PIKASHUNIUMZ, :ULTRANECROZIUMZ
  ]
...
def pbPokemonMart4
  stock = [
    :REDORB, :BLUEORB, :GRACIDEA, :ADAMANTCRYSTAL, :GRISEOUSCORE, 
    :LUSTROUSGLOBE, :REVEALGLASS, :DNASPLICERS, :PRISONBOTTLE, 
    :NSOLARIZER, :NLUNARIZER, :RUSTEDSWORD, :RUSTEDSHIELD, :PRISONBOTTLE,
    :REINSOFUNITY, :HEARTHFLAMEMASK, :WELLSPRINGMASK, :CORNERSTONEMASK, 
  ]
...
def pbPokemonMart5
  stock = [
    :MAXMUSHROOM, :MAXSOUP, :TERAPIECE, :MASTERTERAJEWEL
  ]
...
def pbPokemonMart6
  stock = [
  :FRESHSTARTMOCHI, :HEALTHMOCHI, :MUSCLEMOCHI,
  :RESISTMOCHI, :GENIUSMOCHI, :CLEVERMOCHI,
  :SWIFTMOCHI
  ]
...
#=================================================
def pbPokemonMart7(speech = nil, cantsell = false)
  stock = [
    :VENUSAURITE, :CHARIZARDITEX, :CHARIZARDITEY, :BLASTOISINITE, :BEEDRILLITE,
    :PIDGEOTITE, :ALAKAZITE, :SLOWBRONITE, :GENGARITE, :KANGASKHANITE,
    :PINSIRITE, :GYARADOSITE, :AERODACTYLITE, :DRAGONITENITE,
    :AMPHAROSITE, :STEELIXITE, :SCIZORITE, :HERACRONITE, :HOUNDOOMINITE,
    :TYRANITARITE, :SCEPTILITE, :BLAZIKENITE, :SWAMPERTITE, :GARDEVOIRITE,
    :SABLENITE, :MAWILITE, :AGGRONITE, :MEDICHAMITE, :MANECTITE, :SHARPEDONITE,
    :CAMERUPTITE, :ALTARIANITE, :BANETTITE, :ABSOLITE, :GLALITITE, :SALAMENCITE,
    :METAGROSSITE, :LOPUNNITE, :GARCHOMPITE, :LUCARIONITE,
  ...
  if $game_self_switches[[5, 24, "A"]]
    index = stock.index(:DRAGONITENITE)
    if index
      stock.insert(index + 1, :MEGANIUMITE)
    else
      stock << :MEGANIUMITE
    end
  end 
  
   if $game_self_switches[[49, 13, "A"]]
    index = stock.index(:MEGANIUMITE)
    index = stock.index(:DRAGONITENITE) if index.nil?
    if index
      stock.insert(index + 1, :FERALIGITE)
    else
      stock << :FERALIGITE
    end
  end 
  
  if $game_self_switches[[6, 43, "A"]]
    index = stock.index(:GALLADITE)
    if index
      stock.insert(index + 1, :EMBOARITE)
    else
      stock << :EMBOARITE
    end
  end
  
  if $game_self_switches[[59, 24, "A"]]
      stock << :DRAMPANITE
  end
...
#=================================================
def pbPokemonMart8(speech = nil, cantsell = false)
  stock = [
  :ADAMANTMINT, :MODESTMINT, :TIMIDMINT, :JOLLYMINT,
  :LONELYMINT, :NAUGHTYMINT, :BRAVEMINT,
  :BOLDMINT, :IMPISHMINT, :LAXMINT, :RELAXEDMINT,
  :MILDMINT, :RASHMINT, :QUIETMINT, :CALMMINT,
  :GENTLEMINT, :CAREFULMINT, :SASSYMINT, :HASTYMINT,
  :NAIVEMINT, :SERIOUSMINT, :ABILITYCAPSULE, :ABILITYPATCH
    
  ]

if $bag.has?(:DYNAMAXBAND)
  stock << :MAXSOUP
end
